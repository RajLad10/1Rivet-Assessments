                ...
                if (key.action !== 'ACTION') {
                    ...
                    if (key.status === 'STATUS') {
                        ...
                        if (customer[Object.keys(key)] === 'Open') {
                            span.style.backgroundColor = "rgb(215, 210, 252)";
                            span.style.color = "blue";
                        }
                        else if (customer[Object.keys(key)] === 'Error') {
                            span.style.backgroundColor = "rgb(254, 210, 210)";
                            span.style.color = "red";
                        }
                        else if (customer[Object.keys(key)] === 'Success') {
                            span.style.backgroundColor = "rgb(178, 253, 180)";
                            span.style.color = "green";
                        }
                        else {
                            span.style.backgroundColor = "rgb(209, 208, 208)";
